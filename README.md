...
- 02 TransCAD results (software version: 9.0)
  ...
  - cityname_link.shp / cityname_node.shp : shapefile network data supported by GIS software, which can be imported into TransCAD manually. Then the corresponding '.dbd' file can be generated for **TransCAD with a lower version than than 9.0**
